...
const SwipeToolbar = () => {
    return(
        <div className="swiper-container-toolbar swiper-toolbar swiper-init" data-effect="slide"
            ...
            <div className="swiper-wrapper">
                <div className="swiper-slide toolbar-icon">
                    ...
                    <a href="#" data-popup=".popup-login" className="open-popup"><img
                ...
                <div className="swiper-slide toolbar-icon">
                    ...
                    <a href="#" data-popup=".popup-social" className="open-popup"><img
                    ...
                    <a href="tel:12345678" className="external"><img src="images/icons/blue/phone.png"
